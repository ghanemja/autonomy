...
#include "rviz_plugin_tutorial_msgs/msg/detail/point2_d__rosidl_typesupport_fastrtps_c.h"
...
#include "rviz_plugin_tutorial_msgs/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_rviz_plugin_tutorial_msgs
...
using _Point2D__ros_msg_type = rviz_plugin_tutorial_msgs__msg__Point2D;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rviz_plugin_tutorial_msgs
size_t get_serialized_size_rviz_plugin_tutorial_msgs__msg__Point2D(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Point2D__ros_msg_type * ros_message = static_cast<const _Point2D__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _Point2D__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_rviz_plugin_tutorial_msgs__msg__Point2D(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rviz_plugin_tutorial_msgs
size_t max_serialized_size_rviz_plugin_tutorial_msgs__msg__Point2D(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rviz_plugin_tutorial_msgs__msg__Point2D;
    is_plain =
      (
      offsetof(DataType, y) +
      last_member_size
...
static size_t _Point2D__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rviz_plugin_tutorial_msgs__msg__Point2D(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rviz_plugin_tutorial_msgs, msg, Point2D)() {
